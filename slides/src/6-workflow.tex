...
\begin{frame}{Workflow - reserve}
    ...
    \begin{block}{gRPC - Quarkus}
        \begin{itemize}
            ...
            \item Il clinet compila il file \textit{.proto} e può chiamare i metodi del server come fossero locali.
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{Workflow - reserveflow}

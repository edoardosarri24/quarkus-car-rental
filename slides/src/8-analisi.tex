...
\begin{frame}{Analisi E2E}
    ...
    \begin{block}{Scenario}
        \begin{itemize}
            ...
            \item Soft-real time: per garantire un dato Service Level Agreements (SLA), si deve lavorare su un upper-buond del tempo di esecuzione.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Analisi E2E}
    \begin{block}{Possibilità di analisi}
        \begin{itemize}
            \item Esatta: Fattibile per workflow non complessi e/o tempi di esecuzine Markoviani. In altri casi lo spazio degli stati esplode.
...
\begin{frame}{Analisi E2E}
    \begin{block}{Distribuzioni}
        ...
        \begin{itemize}
            ...
            \item Ottenere statistiche descrittive dei tempi di esecuzine.
    ...
    \begin{block}{Distribuzione E2E (Eulero)}
        ...
        \begin{columns}
            \begin{column}{.5\textwidth}
                \centering
                \includegraphics[width=\textwidth]{images/8-analisi/complete_E2E_workflow_analysis_CDF.pdf}
            \end{column}
            \begin{column}{.5\textwidth}
                \centering
                \includegraphics[width=\textwidth]{images/8-analisi/complete_E2E_workflow_analysis_PDF.pdf}
            \end{column}
        \end{columns}
    \end{block}
\end{frame}
...
\begin{frame}{Analisi E2E}
    \begin{block}{Distribuzione E2E (Eulero)}
        \centering
        \includegraphics[width=.7\textwidth]{images/8-analisi/500ms_E2E_workflow_analysis_CDF.pdf}
    \end{block}
\end{frame}
...
A questo abbiamo il worflow con i microservizi che vengono chiamati, mostrati in Figura~\ref{fig:new_workflow_sequence}, e le distribuzioni dei tempi di esecuzione di ogni microservizio, mostrati in Figura~\ref{fig:distributions}: possiamo eseguire la simulazione su Eulero.

Il tool modella il nostro workflow con qualcosa di simile a quello che possiamo osservare in Figura~\ref{fig:STPN_workflow}. Possiamo vedere invece la CDF e la PDF del tempo di esecuzione E2E del workflow in Figura~\ref{fig:E2E_CDF} e in Figura~\ref{fig:E2E_PDF}.
\begin{figure}[htbp]
    \centering
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/6-analisi/complete_E2E_workflow_analysis_CDF.pdf}
        \caption{CDF.}
        \label{fig:E2E_CDF}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/6-analisi/complete_E2E_workflow_analysis_PDF.pdf}
        \caption{PDF.}
        \label{fig:E2E_PDF}
    \end{subfigure}
    \caption{Distribuzioni del tempo di esecuzione E2E del workflow.}
\end{figure}

\myskip

Per una visualizzazione migliore possiamo osservare la Figura~\ref{fig:E2E_CDF_zoom}. Come abbiamo giù osservato, con queste informzioni riusciamo adesso a fare un'analisi più approfondità e precisa di quelli che possono essere vincoli di soft real-time o considerazioni precise sulla durata del tempo E2E del nostro workflow.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/6-analisi/500ms_E2E_workflow_analysis_CDF.pdf}
    \caption{CDF del tempo di esecuzione E2E del workflow in $[0ms,500ms]$.}
    \label{fig:E2E_CDF_zoom}
\end{figure}
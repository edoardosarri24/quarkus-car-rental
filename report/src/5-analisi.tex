...
In Figura~\ref{fig:comparison_real_eurlero_distribution} possiamo osservare il risultato ottenuto.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{images/6-analisi/compare_e2e_distribution.pdf}
    \caption{Eulero and real distribution.}
    \label{fig:comparison_real_eurlero_distribution}
\end{figure}
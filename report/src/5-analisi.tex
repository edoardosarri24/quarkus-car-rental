...
\begin{itemize}
    \item Le bande ottenute con il metodo di Clopper-Pearson sono mostrate in Figura~\ref{fig:correlation0_clopper_perason}.
    \item Le bande ottenute con il metodo DKW sono mostrate in Figura~\ref{fig:correlation0_dkw}.
    \item Le bande pointwise ottenute con il metodo del bootstrapping sono mostrate in Figura~\ref{fig:correlation0_bootstrap_pointwise}.
    \item Le bande simultanee ottenute con il metodo del bootstrapping sono mostrate in Figura~\ref{fig:correlation0_bootstrap_simultaneous}.
\end{itemize}

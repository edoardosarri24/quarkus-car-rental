...
#external services
cd services_with_correlation/high_correlation/external-services
...
./jaeger-helm.sh
kubectl apply -f pvc-traces.yaml
...
cd services_with_correlation/high_correlation/billing-service
